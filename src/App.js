  ...
  return (
   <>
      <div className="max-w-xl mx-auto p-5 flex flex-col justify-center h-screen">
        <article className="softred p-8 rounded-2xl shadow flex items-center justify-between" >
        ...
        <article className="bg-white p-8 mt-8 rounded-2xl shadow">
          <article className="pb-8"><h1 className="font-bold text-2xl md:text-3xl mb-5">Spending- Last 7 days</h1>
        <Bar data={state} /></article>
